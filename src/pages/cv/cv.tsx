            ...
            <Box className="BoxPersonalInputs">
              <FormControl className="FormControlInputLabel">
                ...
                <Select
                  ...
                  label="Grade"
                >
                  <MenuItem className="MenuItem">Specialist</MenuItem>
                  <MenuItem className="MenuItem">Manager</MenuItem>
                  <MenuItem className="MenuItem">Senior manager</MenuItem>
                  <MenuItem className="MenuItem">Head</MenuItem>
                  <MenuItem className="MenuItem">Director</MenuItem>
                  <MenuItem className="MenuItem">Executive</MenuItem>
                  <MenuItem className="MenuItem">Other...</MenuItem>
                </Select>
              </FormControl>
